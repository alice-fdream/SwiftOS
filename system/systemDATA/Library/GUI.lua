...
require('get_them')
buffer.drawChanges = buffer.update
css_ref()
-----------------------------------------------------------------------------------------
...
local GUI = {
	...
	CONTEXT_MENU_DEFAULT_TEXT_COLOR = text,
	
	-- FIX NOWWW
	CONTEXT_MENU_DEFAULT_BACKGROUND_COLOR = backgr,
	-- HHH
	
	CONTEXT_MENU_PRESSED_BACKGROUND_COLOR = button_active,
	CONTEXT_MENU_PRESSED_TEXT_COLOR = main_text,
...
function GUI.filesystemDialog(x, y, width, height, submitButtonText, cancelButtonText, placeholderText, path)
	...
	-- FIX NOW
	filesystemDialog:addChild(GUI.panel(1, height - 2, width, 3, backgr))
	-- FIX NOW	
	
	filesystemDialog.cancelButton = filesystemDialog:addChild(GUI.adaptiveRoundedButton(1, height - 1, 1, 0, close_button, text, button_active, text, cancelButtonText))
	filesystemDialog.submitButton = filesystemDialog:addChild(GUI.adaptiveRoundedButton(1, height - 1, 1, 0, button_def, text, button_active, text, submitButtonText))
	...
	filesystemDialog.input = filesystemDialog:addChild(GUI.input(2, height - 1, 1, 1, input_back, text, text, input_back_foc, text, "", placeholderText))
-- FIX NOW
	filesystemDialog.filesystemTree = filesystemDialog:addChild(GUI.filesystemTree(1, 1, width, height - 3, backgr, text, text, text, backgr, text, text, text, text, text))
